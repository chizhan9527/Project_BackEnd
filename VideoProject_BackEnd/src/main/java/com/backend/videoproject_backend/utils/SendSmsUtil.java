...
import com.backend.videoproject_backend.config.SmsConfig;
...
public class SendSmsUtil {
    ...
    public boolean sendSms(String phone, String code) {
        try {
             ...
             * 如有需要请在代码中查阅以获取最新的默认值 smsConfig.getExpireTime() */
            System.out.println(smsConfig.getExpireTime());
            httpProfile.setConnTimeout(Integer.parseInt(smsConfig.getExpireTime()));
            ...
            req.setSignName(smsConfig.getSmsSign());
            ...
            String[] templateParamSet = {code,(smsConfig.getExpireTime())};
